---
title: "IISER Advanced Bioacoustics Workshop - Abundance of unmarked animals from paired acoustic and count data"
...
3.  Relate VAR to estimated species abundance to estimate an acoustically-derived index of abundance. We will also relate VAR to raw count data for comparison.
...
#create a site (rows) by visit (columns) dataframe to fill with a detection history
...
# define true abundance 
  ...
  # thus, our simulated VAR data reflects that an animal calls about 5x per sampling occasion (e.g., 4 animals x 5 calls = 20 calls total)
N <- rep(c(0:4),10) 
