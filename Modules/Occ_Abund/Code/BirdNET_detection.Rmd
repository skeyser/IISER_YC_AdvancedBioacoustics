...
You might also want to check how different thresholds affect the number of sites that have detections or not. Ideally, the thresholds will produce the same number of sites where an animal was detected at least once.
